...
if __name__ in "__main__":
    ...
    # 全部の重み
    definer = KmeansTotalClusterDefiner(n_clusters=MAX_CLUSTER_NUM, kmeans_cluster_num=KMEANS_CLUSTER_NUM, cluster_range=3)
